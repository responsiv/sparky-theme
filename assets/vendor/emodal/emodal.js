 ...
 * Licensed under MIT.
 * ========================================================================
 * Script has been modified to support October CMS $.request
 * ======================================================================== */
...
; (function (define) {
    define(['jquery'], function ($, root) {
        ...
        /**
         * Gets data from AJAX handler to eModal body
         * @param {Object | String} data - this can be the message string or the full detailed object
         * @param {String} title - the string that will be shown in modal header
         * @returns {Promise} Promise with modal $DOM element
         */
        function request(data, title) {
            ...
            // This intentionally updates nothing, instead the content
            // is extracted via the ok() function in the code below
            if (params.partial) {
            ...
            function error(responseText/*, textStatus*/) {
                var msg = '<div class="alert alert-danger">' +
                    '<strong>XHR Fail: </strong>URL [ ' + params.handler + '] load fail.' +
                    '</div>';
